...
const MainWeather = ({
  ...
  return (
    <div
      className="relative rounded-lg overflow-hidden h-64 shadow-lg flex items-center"
      style={{
        ...backgroundWeather,
    ...
    >
      ...
      <div className="relative z-10 text-white p-4 flex flex-col w-full h-full justify-between">
